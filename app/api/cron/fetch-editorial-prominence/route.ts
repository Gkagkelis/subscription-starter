...
const MICRO_AGENDA_RULES: MicroAgendaRule[] = [
  ...
  },
  {
    ...
    keywords: [
      ...
      "βουλη", "πρωθυπουργ", "μαξιμου", "μαξίμου", "κοινοβουλ", "πολιτικ σκηνικ", "κυβερνητικ",
      "νεα δημοκρατια", "ν.δ.", "μητσοτακ",
      "πασοκ", "ανδρουλακ", "κινημα αλλαγης", "κιναλ",
      "συριζα", "κουλογλ", "τσιπρα",
      "κκε", "κουτσουμπ", "περισσος",
      "ελληνικη λυση", "βελοπουλ",
      "νικη", "νατσιο",
      "πλευση ελευθεριας", "κωνσταντοπουλ",
      "μερα25", "μερα 25", "βαρουφακ",
      "νεα αριστερα", "ζαχαριαδ", "χαριτσ",
      "φωνη λογικης", "λατινοπουλ",
      "σπαρτιατ", "ελληνες", "νικολοπουλ",
      "δημοκρατικο πατριωτικο", "σαμαρα",
      "αντωνοπουλ", "καρυστιανου", "φλωρ",
      "δενδια", "γερουλανο", "δουκα", "μπακογιανν", "καιρ",
      "αχτσιογλ", "πολακη", "φαμελλ",
      "γεωργιαδ", "θεοδωρικακ", "χατζηδακ", "κεραμεω", "βορίδ", "βοριδ", "πιερρακακ", "σκερτσ", "μαρινακ", "βενιζελ"
    ],
    priority: 25,
  },
  {
