...
Γραψε τη ΣΗΜΕΡΙΝΗ ΑΝΑΓΝΩΣΗ για τον υποψηφιο ΠΑΣΟΚ στη Β' Θεσσαλονικης: ποιο ΤΟΠΙΚΟ θεμα ειναι η μεγαλυτερη ΕΥΚΑΙΡΙΑ, ποια η παγιδα, ποια η πρωτη κινηση καμπανιας. Ανεφερε συγκεκριμενα τοπικα στοιχεια. 4-6 προτασεις, πυκνα, χωρις markdown.`;
    const text = await callClaude(system, user, 750);
