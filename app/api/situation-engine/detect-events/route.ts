...
αθλητικά, διεθνή/ξένα χωρίς ελληνικό αντίκτυπο, ΞΕΝΕΣ ΕΤΑΙΡΕΙΕΣ (Microsoft, Google, Amazon, Tesla κ.λπ.) & ξένη βιομηχανία/οικονομία χωρίς Ελλάδα, εμπορικά/διαφημιστικά (εκπτώσεις, προσφορές, Black Friday).
