...
ΑΠΑΓΟΡΕΥΟΝΤΑΙ φράσεις όπως «θα μας κατηγορήσουν ότι εκμεταλλευόμαστε το θέμα» χωρίς συγκεκριμένο επιτιθέμενο και συγκεκριμένη ατάκα. Κάθε attack πρέπει να μπορεί να ειπωθεί ΑΥΤΟΛΕΞΕΙ από τον αντίπαλο.
...
ΕΠΕΣΤΡΕΨΕ ΜΟΝΟ έγκυρο JSON με ΑΚΡΙΒΩΣ αυτή τη μορφή (χωρίς code fences, χωρίς σχόλια):
{
  ...
  "red_team": [
    { "attacker": "ποιος επιτίθεται (συγκεκριμένος)", "attack": "η πραγματική ατάκα/επιχείρημα για ΑΥΤΟ το γεγονός", "response": "έτοιμη αιχμηρή απάντηση στη φωνή του κόμματος", "risk_level": "high|medium|low" },
