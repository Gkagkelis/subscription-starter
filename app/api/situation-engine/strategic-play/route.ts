...
function cacheKey(microAgendaId: string, partyKey: string, eventId?: string | null) {
  const base = "strategic_play_v3__" + microAgendaId + "__" + partyKey;
...
- Αν η κίνηση ΔΕΝ χρειάζεται κανένα παραγόμενο κείμενο (π.χ. καθαρή αναμονή/παρακολούθηση χωρίς λόγο), τότε άφησε ΚΕΝΟ ("").
