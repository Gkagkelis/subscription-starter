...
// ============================================================
// NORAYA — DEMO ΣΕΛΙΔΑ (ΑΣΥΝΔΕΤΗ) · Υποψηφιος/α Βουλευτης ΠΑΣΟΚ, Β' Θεσσαλονικης
// Route: /demo/ypopsifios-pasok  (εκτος μενου)
...
export default function DemoCandidatePasok() {
  ...
  useEffect(() => {
    (async () => {
      try {
        const r = await fetch("/api/agenda/timeline?token=dev&party=pasok", { cache: "no-store" });
  ...
  // Τοπικη ατζεντα (πραγματικη — Google News Θεσσαλονικη)
  useEffect(() => {
    (async () => {
      try {
  ...
  return (
    <div className="min-h-screen bg-[#060a14] text-zinc-100">
      <div className="w-full border-b border-amber-300/20 bg-amber-400/10 px-4 py-2 text-center text-[12px] text-amber-200">
        DEMO — Προφιλ <b>Υποψηφιου Βουλευτη</b> (πλασματικο προσωπο) · ασυνδετη σελιδα · πραγματικο AI, εθνικη &amp; τοπικη ατζεντα
      </div>
      ...
      <div className="mx-auto max-w-6xl px-5 py-6">
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[17px] font-semibold">[Ονομα Υποψηφιου]</div>
              <div className="text-[12px] text-zinc-400">
                Υποψηφιος/α Βουλευτης · <span style={{ color: GREEN_L }}>ΠΑΣΟΚ – Κινημα Αλλαγης</span> · Β' Θεσσαλονικης
              </div>
            </div>
          </div>
        ...
        <Card className="mb-5">
          ...
          {dailyLoading ? (
            <div className="text-[13px] text-zinc-500">Ο Noraya διαβαζει τα τοπικα της Β' Θεσσαλονικης…</div>
          ) : (
        ...
        <Card className="mb-5">
          <div className="mb-3 flex items-center justify-between">
            <div className="text-[11px] tracking-[0.08em]" style={{ color: GREEN_L }}>
              ΤΟΠΙΚΗ ΑΤΖΕΝΤΑ — Β' ΘΕΣΣΑΛΟΝΙΚΗΣ
            </div>
            <div className="text-[10px] text-zinc-500">πραγματικα τοπικα πρωτοσελιδα</div>
          </div>
          {localLoading ? (
            <div className="text-[13px] text-zinc-500">Φορτωση τοπικων ειδησεων Θεσσαλονικης…</div>
          ) : local.length === 0 ? (
        ...
        <div className="grid gap-5 md:grid-cols-[1.4fr_1fr]">
          ...
          <Card>
            ...
            <ul className="space-y-2.5 text-[13px] text-zinc-300">
              ...
              <li className="flex gap-2">
                <span style={{ color: GREEN_L }}>›</span> <b>Προσωπικο αφηγημα</b> δεμενο με τη γραμμη ΠΑΣΟΚ.
              </li>
            </ul>
          </Card>
        </div>
        ...
        <Card className="mt-5">
          ...
          {redTeam.length === 0 ? (
            <div className="text-[13px] text-zinc-500">
              Πατα «Δες τις επιθεσεις» — ο Noraya βγαζει τις πιθανες επιθεσεις (συνυποψηφιοι ΠΑΣΟΚ, ΝΔ, ΣΥΡΙΖΑ/ΕΛΑΣ) με ετοιμη απαντηση.
            </div>
          ) : (
