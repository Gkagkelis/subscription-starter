  ...
  return (
    <div className="flex flex-col items-center text-center px-6">
      <div className="mt-20 mb-6">
        ...
        <p className="text-xs tracking-[0.25em] text-zinc-600 uppercase mb-12">
        ...
        <h2 className="text-2xl md:text-3xl font-light text-white max-w-xl mx-auto mb-4 leading-relaxed">
          AI παρακολούθηση, ανάλυση και πρόβλεψη δημόσιου λόγου
        </h2>

        <p className="text-sm text-zinc-600 max-w-md mx-auto mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-zinc-800/50 rounded-xl overflow-hidden border border-zinc-800/50">
          <div className="bg-zinc-950 p-6 text-left">
            ...
            <p className="text-xs text-zinc-600 leading-relaxed">
              Real-time tracking ΜΜΕ, Βουλής και social media. Sentiment
              analysis και alerts.
            </p>
          </div>
          ...
          <div className="bg-zinc-950 p-6 text-left">
            <p className="text-cyan-400 text-lg mb-2">&#9679;</p>
            <p className="text-sm font-medium text-zinc-200 mb-1">
              AI Πολιτικός Αναλυτής
            </p>
            <p className="text-xs text-zinc-600 leading-relaxed">
              Ρωτήστε οτιδήποτε. AI ανάλυση με βάση τα δεδομένα και τις θέσεις
              σας.
            </p>
          </div>
          ...
          <div className="bg-zinc-950 p-6 text-left">
            ...
            <p className="text-xs text-zinc-600 leading-relaxed">
              Κάθε οργανισμός βλέπει μόνο τα δικά του. Audit trail, GDPR.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mb-16">
        <p className="text-xs tracking-[0.2em] text-zinc-700 uppercase mb-4">
          Για ποιον
        </p>
      ...
      <div className="mb-20 max-w-lg">
        <div className="p-8 rounded-xl border border-zinc-800 bg-zinc-900/30">
          ...
          <p className="text-sm text-zinc-500 mb-6">
            Επικοινωνήστε μαζί μας για pilot ή demo.
          </p>
